...
void main() {
  ...
  color = mix(color, vec3(1.0, 0.95, 0.8), innerGlow * 0.5);
...
export function EnergyFlow({ buildProgress, flowSpeed }: EnergyFlowProps) {
  ...
  const geometry = useMemo(() => {
    ...
    const flowPaths = [
      ...
      {
        segments: [
          { start: [0, 8, 0], end: [0, 25, 0] },
          { start: [0, 25, 0], end: [0, 45, 0] },
        ],
        particlesPerSegment: 25,
      },
      // Flow to mud pits (left side)
      {
        segments: [
          { start: [-4, 8, 0], end: [-10, 6, -2] },
          { start: [-10, 6, -2], end: [-18, 3, -5] },
        ],
        particlesPerSegment: 15,
      },
      // Flow to power unit (right side)
      {
        segments: [
          { start: [4, 8, 0], end: [10, 6, 0] },
          { start: [10, 6, 0], end: [18, 4, 0] },
        ],
        particlesPerSegment: 15,
      },
      ...
      {
        segments: [
          { start: [-18, 3, -5], end: [-12, 4, 0] },
          { start: [-12, 4, 0], end: [-4, 6, 0] },
        ],
        particlesPerSegment: 12,
      },
    ];
